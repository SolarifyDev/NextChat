...
const cs: PartialLocaleType = {
 ...
 `,
  ...
  Kid: {
    NoKidText: "Ještě nemáš AI Kid~",
    InstructionText: "Klikni na「+」níže a přivolej si vlastního AI Kid~",
    Create: "Vytvořit",
  },
  SelectVoice: {
    Title: "Vybrat Hlas",
  ...
  AddOrUpdateAiKid: {
    ...
    Edit: "Upravit",
    Name: "Jméno",
    VoicePreference: "Nastavení hlasu",
    InputName: "Zadejte jméno",
    CreateCustomVoice: "Vytvořit vlastní hlas",
    AbilitySettings: "Nastavení schopností",
    Polish: "Vylepšení",
    Introduction: "Úvod",
    IntroduceYourAiKid: "Představte svého AI Kid",
    OpeningLine: "Úvodní řádek",
