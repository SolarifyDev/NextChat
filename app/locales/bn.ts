...
const bn: PartialLocaleType = {
 ...
 `,
  ...
  ChatItem: {
    ChatItemCount: `{{count}} টি চ্যাট`,
  },
  Chat: {
    SubTitle: `মোট {{count}} টি চ্যাট`,
    EditMessage: {
  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview:
        "{{chat}} বার চ্যাট, {{message}} বার্তা, {{prompt}} প্রম্পট, {{mask}} মাস্ক",
    ...
    Prompt: {
      ...
      ListCount: "ইনবিল্ট {{builtin}} টি, ব্যবহারকারী সংজ্ঞায়িত {{custom}} টি",
      Edit: "সম্পাদনা করুন",
      Modal: {
    ...
    Usage: {
      Title: "ব্যালেন্স চেক",
      SubTitle: "এই মাসে ব্যবহৃত ${{used}}, সাবস্ক্রিপশন মোট ${{total}}",
  ...
  Store: {
    ...
    Prompt: {
      History: "এটি পূর্বের চ্যাটের সারাংশ হিসেবে ব্যবহৃত হবে: {{content}}",
      Topic:
  ...
  Context: {
    Toast: "{{x}}টি পূর্বনির্ধারিত প্রম্পট অন্তর্ভুক্ত",
  ...
  SearchChat: {
    ...
    Page: {
      ...
      SubTitle: "{{count}} টি ফলাফল পাওয়া গেছে",
    },
    Item: {
      View: "দেখুন",
    },
  ...
  Mask: {
    ...
    Page: {
      ...
      SubTitle: "{{count}}টি পূর্বনির্ধারিত চরিত্র সংজ্ঞা",
      Search: "চরিত্র মাস্ক অনুসন্ধান করুন",
      Create: "নতুন তৈরি করুন",
    },
    Item: {
      Info: `ভিতরে {{count}}টি পূর্বনির্ধারিত চ্যাট রয়েছে`,
      Chat: "চ্যাট",
      View: "দেখুন",
      Edit: "সম্পাদনা করুন",
      Delete: "মুছে ফেলুন",
    ...
    EditModal: {
      Title: "পূর্বনির্ধারিত মাস্ক সম্পাদনা",
      ReadOnlyTitle: "পূর্বনির্ধারিত মাস্ক সম্পাদনা （পঠনযোগ্য）",
