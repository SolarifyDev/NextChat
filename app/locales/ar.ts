...
const ar: PartialLocaleType = {
 ...
 `,
  ...
  ChatItem: {
    ChatItemCount: `{{count}} محادثة`,
  },
  Chat: {
    SubTitle: `إجمالي {{count}} محادثة`,
    EditMessage: {
  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview:
        "{{chat}} دردشة، {{message}} رسالة، {{prompt}} إشعار، {{mask}} قناع",
    ...
    Prompt: {
      ...
      ListCount: "مدمج {{builtin}} إشعار، مخصص {{custom}} إشعار",
      Edit: "تحرير",
      Modal: {
    ...
    Usage: {
      ...
      SubTitle: "تم استخدام ${{used}} هذا الشهر، إجمالي الاشتراك ${{total}}",
  ...
  Store: {
    ...
    Prompt: {
      History: "هذا ملخص للدردشة السابقة كنقطة انطلاق: {{content}}",
      Topic:
  ...
  Context: {
    Toast: "يحتوي على {{x}} إشعارات مخصصة",
  ...
  SearchChat: {
    ...
    Page: {
      ...
      SubTitle: "تم العثور على {{count}} نتائج",
    },
    Item: {
      View: "عرض",
    },
  ...
  Mask: {
    ...
    Page: {
      ...
      SubTitle: "{{count}} تعريف لدور مخصص",
      Search: "بحث عن قناع الدور",
      Create: "إنشاء جديد",
    },
    Item: {
      Info: `يحتوي على {{count}} محادثات مخصصة`,
      Chat: "الدردشة",
      View: "عرض",
      Edit: "تحرير",
      Delete: "حذف",
    ...
    EditModal: {
      Title: "تحرير القناع المخصص",
      ReadOnlyTitle: "تحرير القناع المخصص (للقراءة فقط)",
  ...
  Kid: {
    NoKidText: "ليس لديك AI Kid بعد~",
    InstructionText: "انقر على「+」أدناه لاستدعاء AI Kid الخاص بك~",
    Create: "إنشاء",
  },
  SelectVoice: {
    Title: "اختر الصوت",
    ...
    Male: "صوت ذكري",
    Dialect: "لهجة",
    MatureMale: "صوت ذكري ناضج",
    GentleFemale: "صوت أنثوي لطيف",
    YoungMale: "ذكر | شاب",
    YoungFemale: "أنثى | شابة",
    Confirm: "إتمام",
  ...
  AddOrUpdateAiKid: {
    ...
    Edit: "تعديل",
    Name: "الاسم",
    VoicePreference: "تفضيل الصوت",
    InputName: "أدخل الاسم",
    CreateCustomVoice: "إنشاء صوت مخصص",
    AbilitySettings: "إعدادات القدرات",
    Polish: "تحسين",
    Introduction: "مقدمة",
    IntroduceYourAiKid: "قدم طفلك الذكي",
    OpeningLine: "الرسالة الافتتاحية",
