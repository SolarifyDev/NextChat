...
const ru: PartialLocaleType = {
 ...
 `,
  ...
  ChatItem: {
    ChatItemCount: `{{count}} бесед`,
  },
  Chat: {
    SubTitle: `Всего {{count}} бесед`,
    EditMessage: {
  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview:
        "{{chat}} бесед, {{message}} сообщений, {{prompt}} подсказок, {{mask}} масок",
    ...
    Prompt: {
      ...
      ListCount: "Встроенные {{builtin}}, пользовательские {{custom}}",
      Edit: "Редактировать",
      Modal: {
    ...
    Usage: {
      ...
      SubTitle:
        "Использовано в этом месяце ${{used}}, всего по подписке ${{total}}",
      IsChecking: "Проверка…",
  ...
  Store: {
    ...
    Prompt: {
      History: "Это резюме истории чата как предыстория: {{content}}",
      Topic:
  ...
  Context: {
    Toast: "Содержит {{x}} предустановленных подсказок",
  ...
  SearchChat: {
    ...
    Page: {
      ...
      SubTitle: "Найдено {{count}} результатов",
    },
    Item: {
      View: "Просмотр",
    },
  ...
  Mask: {
    ...
    Page: {
      ...
      SubTitle: "{{count}} предустановленных ролей",
      Search: "Поиск ролей",
      Create: "Создать",
    },
    Item: {
      Info: `Содержит {{count}} предустановленных диалогов`,
      Chat: "Диалог",
      View: "Просмотреть",
      Edit: "Редактировать",
      Delete: "Удалить",
    ...
    EditModal: {
      Title: "Редактирование предустановленной маски",
      ReadOnlyTitle:
        "Редактирование предустановленной маски（только для чтения）",
